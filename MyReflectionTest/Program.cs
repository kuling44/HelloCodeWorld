    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // Console.ReadKey();
            ...
            //Assembly myAssembly = Assembly.Load("Ruanmou.DB.SqlServer");
            //Type myType = myAssembly.GetType("Ruanmou.DB.SqlServer.GenericMethod");
            //object obMy = Activator.CreateInstance(myType);
            //MethodInfo methodMy = myType.GetMethod("Show1", new Type[] { typeof(string), typeof(int), typeof(DateTime) });
            //methodMy.Invoke(obMy, new object[] { "123", 1, DateTime.Now });
